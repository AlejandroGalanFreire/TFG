# -*- coding: utf-8 -*-
"""
Created on Mon Feb 27 18:00:43 2023
...
objScoreboard = Scoreboard(game_date="2023-06-12")
...
scoreboard_string = objScoreboard.get_response()
scoreboard_dictionary = json.loads(scoreboard_string)
