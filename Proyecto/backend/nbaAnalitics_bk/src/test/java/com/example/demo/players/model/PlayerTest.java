...
class PlayerTest {
	...
	void test() {
		...
		EqualsVerifier.simple().forClass(Player.class)
		...
		.withPrefabValues(Player.class, player1, player2)
		.verify();
		
	}

	private void callSets(Player player) {
	...
	private void callGets(Player player) {
		player.getPlayerId();
