...
public class TeamStatsByYear extends CommonStats{
	...
	public int hashCode() {
		return Objects.hash(getAst(), getBlk(), confCount, confRank, conference, divCount, divRank, division, getDreb(), getFg3Pct(), getFg3a(),
				getFg3m(), getFgPct(), getFga(), getFgm(), getFtPct(), getFta(), getFtm(), gp, id, losses, nbaFinalsAppearance, getOreb(), getPf(), poLosses, poWins,
	...
	public boolean equals(Object obj) {
		...
		return getAst() == other.getAst() && getBlk() == other.getBlk() && confCount == other.confCount && confRank == other.confRank
				...
				&& getFtm() == other.getFtm() && gp == other.gp && id == other.id && losses == other.losses
