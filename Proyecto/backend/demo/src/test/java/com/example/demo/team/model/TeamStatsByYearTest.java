...
class TeamStatsByYearTest {

	@Test
	void test() {
		TeamStatsByYear team1 = new TeamStatsByYear();
		callSets(team1);
		callGets(team1);
		
		
		TeamStatsByYear team2 = new TeamStatsByYear();
		EqualsVerifier.simple().forClass(TeamStatsByYear.class)
		...
		.withPrefabValues(TeamStatsByYear.class, team1, team2)
		.verify();
	}
	
	private void callSets(TeamStatsByYear team) {
		team.setId(1);
		team.setTeamId(1);
	...
	private void callGets(TeamStatsByYear team) {
		team.getId();
		team.getTeamId();
		team.getTeamName();
		team.getTeamCity();
