# -*- coding: utf-8 -*-
"""
Created on Wed Apr 19 19:36:40 2023
...
objBoxScore = BoxScore('0022201222')
objBoxScore.load_response()
boxScore_string = objBoxScore.get_response()
boxScore_dictionary = json.loads(boxScore_string)
